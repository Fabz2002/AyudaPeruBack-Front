...
public class Donacion {
	...
	@Column(name = "tipodonacion", length = 60, nullable = false)
	...
	public Donacion(long id, Pais pais, Tipodocumento tipodocumento, String tipodonacion, String nombre, String apellido, String numerodoc,
